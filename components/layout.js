...
const Layout = () => {
  ...
  return (
    <Fragment>
      <div className="flex h-20 py-7 bg-gray-200 relative">
        ...
        <span className="absolute  right-36 mt-2">
          <ul className="flex  text-sm">
            ...
            <li className="px-4 hover:{show()}">
              <Link href="/"><div className="dropdown inline-block relative">
            ...
            <li className="px-4 mt-0.5">
              <Link href="/"><svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-5" viewBox="0 0 20 20" fill="currentColor">
