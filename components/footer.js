...
const Footer = () => {
  return (
    <>
      <div className="footer bg-black flex  relative">
        ...
        <div className="icons  my-24  flex absolute top-15 right-11 ">
          <svg
            ...
            height="25"
            fill="currentColor"
            className="bi bi-facebook mx-5 text-white"
            viewBox="0 0 16 16"
          >
          ...
          <svg
            ...
            height="25"
            fill="currentColor"
            className="bi bi-linkedin mx-5 text-white"
            viewBox="0 0 16 16"
          >
          ...
          <svg
            ...
            height="25"
            fill="currentColor"
            className="bi bi-instagram mx-5 text-white"
            viewBox="0 0 16 16"
          >
